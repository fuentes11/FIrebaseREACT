...
const Register = ({navigation}) => {
  ...
  const [name, setName] = useState('');//Variable for get the input user(variable para capturar el input de usuario)
        ...
        <ScrollView style={styles.scroll_container}>
            <View style={styles.container}>  
                ...
                <Image source={require('../assets/LolOlgo.png')} style={{borderRadius:15,height: 200, width: 230, margin:0,}} />
                  <TextInput style={styles.inputTxt} placeholder='Nombre' onChangeText={name => setName(name)} defaultValue={name} />
                ...
                <Button  title='Register' color ={'#F2CF66'} onPress={() => {
            ...
            if(validatePassword(password)){
              ...
              alert("Mínimo 8 caracteres, al menos una letra y un número")
